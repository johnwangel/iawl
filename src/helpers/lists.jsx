...
export const CREATIVES = [
	   ...
	   { "head": "Philip Van Doren Stern", desc: "Philip Van Doren Stern (1900-1984) was an historian, novelist, and editor. In 1943, Stern published 'The Greatest Gift', the story on which Frank Capra's 1946 film 'It's A Wonderful Life' was based. The story, which took five years to write,  was based on a dream Stern had on the night of February 11-12, 1938. Stern wrote over 40 books, on aspects of the American Civil War and on subjects ranging from typography to pre-historic art. During World War II, Stern worked as general manager of the Council on Books in Wartime's Armed Services Editions, designing, printing, and distributing over 122 million copies of pocket-sized paperback books for American service members in all theatres of the world war." },
